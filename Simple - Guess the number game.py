    ...
    while guess!=answer:
        ...
        if guess==answer:
            ...
            print("YES {0}! You have done it!"
                  ...
                  "\nYou get your score after {1} times on {2} level in {4:2} seconds.".format(name,times,level,answer,timer))
...
if level==1:
    ...
    print("There is no level 0 {}. Don't be like that".format(name))
